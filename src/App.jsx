...
function App() {
  ...
  useEffect(() => {
    ...
    if (token) {
      setIsAuthenticated(true);
      setUserProfile({ name: "Default User" });
    }
    setLoading(false);
  }, []);
      ...
      <Router>
        <Routes>
          ...
          <Route path="/dashboard" element={<Layout />}>
            ...
            <Route path="add-products" element={<AddNewPro />} />
            <Route path="team-members" element={<TeamMember />} />
            <Route path="profile" element={<Profile />} />
            <Route path="logout" element={<AllProduct />} />
            <Route path="export-data" element={<AllProduct />} />
            <Route path="support" element={<AllProduct />} />
            <Route path="message" element={<Message />} />
            <Route path="track-product" element={<Dashboards />} />
          </Route>

          <Route path="/addStock" element={<ManufacturerForm />} />
        </Routes>
      </Router>
    </AuthProvider>
  );
