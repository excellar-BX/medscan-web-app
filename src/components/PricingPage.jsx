    ...
    <div className="bg-white text-black min-h-screen flex flex-col items-center lg:py-10 max-sm:py-5 md:py-5 max-md:py-5">
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-6">
        <div className="bg-[#15212D] text-white rounded-lg p-6 shadow-lg w-72">
          ...
          <p className="font-bold mb-3">₦0 ($0.000)</p>
        ...
        <div className="bg-[#15212D] text-white rounded-lg p-6 shadow-lg w-72">
          ...
          <p className="font-bold mb-3">₦50 ($0.032)</p>
        ...
        <div className="bg-[#15212D] text-white rounded-lg p-6 shadow-lg w-72">
          ...
          <p className="font-bold mb-3">₦35 ($0.022)</p>
        ...
        <div className="bg-[#15212D] text-white rounded-lg p-6 shadow-lg w-72">
          ...
          <p className="font-bold mb-3">₦25 ($0.016)</p>
        ...
        <div className="bg-[#15212D] text-white rounded-lg p-6 shadow-lg w-72">
          ...
          <p className="font-bold mb-3">₦15 ($0.010)</p>
