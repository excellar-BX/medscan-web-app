...
function Terms(params) {
  ...
  <div className="w-[90%] md:w-[80%] lg:w-[90%] m-auto">
    ...
    <p className="mt-2 tracking-tight">
      - These terms and conditions are governed by and construed in accordance with the laws of the Federal Republic of Nigeria, and you submit to the exclusive jurisdiction of the courts in that state.
    </p>
