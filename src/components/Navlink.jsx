...
export default function Navlink({ isAuthenticated, userProfile }) {
  ...
  return (
    <div>
          ...
          <div className="hidden lg:flex ml-4">
            {!isAuthenticated ? (
              <>
                <Link
                  to="/dashboard"
                  className="ml-4 py-2 px-4 border border-blue-500 text-blue-500 rounded hover:bg-blue-500 hover:text-white"
                >
                  Sign up
                </Link>
                <Link
              ...
              <>
                ...
                <button
                  ...
                  className="py-2 px-4 bg-red-500 text-white rounded hover:bg-red-600 ml-2"
                >
                  Logout
                </button>
              </>
      ...
      {menuOpen && (
        <div className="fixed inset-0 h-screen z-50 bg-white p-8 w-[60%]">
          <FaTimes
            onClick={toggleMenu}
            size={30}
          ...
          <ul className="text-black text-[20px] font-[500] space-y-6">
            ...
            {!isAuthenticated ? (
              <>
                <li className="px-6 h-[55px] flex items-center justify-center text-white rounded bg-[#0084FC]">
                  <Link to="/dashboard" onClick={toggleMenu}>
                    Sign in
                  </Link>
                </li>
                <li className="px-6 h-[55px] flex items-center justify-center text-blue-500 border border-[#0084FC] rounded">
                  <Link to="/dashboard" onClick={toggleMenu}>
                    Sign up
                  </Link>
                </li>
              ...
              <>
                ...
                <li className="px-6 h-[55px] flex items-center justify-center text-white rounded bg-red-500">
